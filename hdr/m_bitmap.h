/****************************************************************************************
    ...
    Révision : 
    Version Initial : Samuel Deslauriers-Gauthier   5 avril 2014 
                      Création de la libraire en VBA.

    Modification    : Francis Bourdeau              3 juin 2014
                      Adaptation de la librairie en C.
...
#ifndef _ETS_INF155_MODULE_BITMAP_
#define _ETS_INF155_MODULE_BITMAP_
...
/*
    ...
    Paramètre:
        ...
        - [void**] image     : L'addresse d'un pointeur non initialisé qui recevra l'image.
                                NOTE : L'utilisateur sera responsable de détruire
                                l'image.
